...
// CALCUALTOR
    function calculator(button){
        if(button.type == "operator"){
            ...
            //GET POWER BASE AND REPLACE WITH CRCT FORM
            ...
            BASES.forEach( base => {
             ...
             //GET FCATORIAL AND REPLACE WITH CRCT FORM
...
function factorialNumberGetter(formula, FACTORIAL_SEARCH_RESULT){
    ...
    FACTORIAL_SEARCH_RESULT.forEach( factorial_index => {  
        ...
        // IF THERE WAS A FACTORIal SEQUENCE , WE NEED TO GET INDEX OF VERY FIRST FACT FUNC
